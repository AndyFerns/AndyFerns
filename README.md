...
- [auto_book_pub](https://github.com/AndyFerns/auto_book_pub) - No description
- [Code-Reformatter](https://github.com/AndyFerns/Code-Reformatter) - a personal project made to help me format code for college submissions
- [flowbit-workflow-orchestration](https://github.com/AndyFerns/flowbit-workflow-orchestration) - No description
- [Match-Result-Predictor](https://github.com/AndyFerns/Match-Result-Predictor) - No description
- [Multi-Agent-System](https://github.com/AndyFerns/Multi-Agent-System) - A project used to parse Intent from .pdf, .json or .txt documents  
- [Neural-Network-NumPy](https://github.com/AndyFerns/Neural-Network-NumPy) - No description
- [ray_tracer](https://github.com/AndyFerns/ray_tracer) - No description
- [Socket-Chat-Application](https://github.com/AndyFerns/Socket-Chat-Application) - A simple mini project aiming to understand and implement socket programming in java
- [vscode-dir-builder](https://github.com/AndyFerns/vscode-dir-builder) - A project used to leverage directory trees provided by LLMs and convert them into actual files and folders in memory
<!--END_PROJECTS-->

_This section is auto-generated by a GitHub Action._
