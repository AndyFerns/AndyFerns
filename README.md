...
- **Automated Reasoning Project**: Implementing automated reasoning in First Order Logic using NLP.
  - GitHub: [Automated-Reasoning-Project](https://github.com/AndyFerns/Automated-Reasoning-Project):contentReference[oaicite:6]{index=6}
