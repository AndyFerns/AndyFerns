...
|---------|-------------|-----------|
| [GBCee](https://github.com/AndyFerns/GBCee) | A Gameboy emulator built entirely in C and the SDL2 library |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [vscode-dir-builder](https://github.com/AndyFerns/vscode-dir-builder) | Leverage directory trees provided by LLMs and convert them into actual files and folders in memory |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [Automated-Reasoning-Project](https://github.com/AndyFerns/Automated-Reasoning-Project) | A project aiming to implement Automated Reasoning in First Order Logic using NLP |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [Determa](https://github.com/AndyFerns/Determa) | Programming Language built from scratch, imitating C with type-safety, a garbage collector and a self-made compiler |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [Match-Result-Predictor](https://github.com/AndyFerns/Match-Result-Predictor) | A project aiming to implement a Random Forest Classifier in order to predict the outcomes of football matches based on historical data |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [NourishFit](https://github.com/AndyFerns/NourishFit) | A Mobile application used to track and maintain diet plans, keep a note of user-running sessions as well as implementing AI/ML to provide users with custom suggestions |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
| [Accessible-Math-Reader](https://github.com/AndyFerns/Accessible-Math-Reader) | No description |  ![documentation_url](https://img.shields.io/badge/documentation_url-gray?style=for-the-badge) ![message](https://img.shields.io/badge/message-gray?style=for-the-badge) |
<!--END_PROJECTS-->
